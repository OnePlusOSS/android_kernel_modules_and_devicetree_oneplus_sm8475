...
dtbo-$(CONFIG_ARCH_WAIPIO) += oplus/udon_22803-camera-waipio-overlay.dtbo
...
dtbo-$(CONFIG_ARCH_CAPE) += oplus/senna-22625-camera-cape-overlay.dtbo
...
dtbo-$(CONFIG_ARCH_WAIPIO) += oplus/lvzhou_22015-camera-waipio-overlay.dtbo
dtbo-$(CONFIG_ARCH_CAPE) += oplus/lvzhou_22015-camera-cape-overlay.dtbo
